...
4. Actualizează `index.html` doar în zona introductivă cu un link către cea mai recentă ediție Radar, după caz. Pentru Investment Committee, actualizează `portfolio/index.html` cu scoruri datate, dovezi și schimbările față de evaluarea precedentă. Nu modifica clasamentul dacă dovezile nu s-au schimbat.
5. Recitește `main` imediat înainte de commit/push. Integrează orice modificare intervenită de la alți agenți, fără reset/force-push și fără rescrierea fișierelor lor. Dacă apare conflict, reia de la noul `main` și aplică numai diferența proprie.
6. Verifică commitul pe `main`, rularea deploy-ului GitHub Pages și URL-ul paginii noi. În notificarea scurtă către utilizator include URL-ul și 1–3 concluzii; dacă un pas eșuează, spune explicit ce s-a publicat și ce nu. Conversația nu este arhiva raportului.
